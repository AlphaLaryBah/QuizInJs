...
function getNewQuestion() {
  ...
  // get the position of 'questionIndex' from avalaibleQuestions Array;
  const index1 = availableQuestions.indexOf(questionIndex);
  // remove the 'questionIndex' from avalaibleQuestions Array, so that the question does not repeat
  ...
  // console.log(currentQuestions.options)
...
// make all the options unclickable once the select an option (RESTRICT USER TO CHANGE THE CHOICE)
function next() {
  if (questionCounter === quiz.length) {
    console.log('quiz iz over');
    quizOver();
  } else {
    getNewQuestion();
  }
